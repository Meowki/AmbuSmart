...
class OperationHistory(Base):
    ...
    initial_eid = Column(Integer, ForeignKey('basic_check.eid', ondelete='RESTRICT', onupdate='RESTRICT'), comment='初检id')
    final_eid = Column(Integer, ForeignKey('basic_check.eid', ondelete='RESTRICT', onupdate='RESTRICT'), comment='终检id')
    ...
    initial_check = relationship("BasicCheck", foreign_keys=[initial_eid])
    final_check = relationship("BasicCheck", foreign_keys=[final_eid])
